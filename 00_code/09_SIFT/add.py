...
# 读取拼接图片
imageA = cv2.imread("F:/Pycharm/opencv/opencv/OpenCV-main/01_Picture/21_Left_01.png")
imageB = cv2.imread("F:/Pycharm/opencv/opencv/OpenCV-main/01_Picture/22_Right_01.png")
